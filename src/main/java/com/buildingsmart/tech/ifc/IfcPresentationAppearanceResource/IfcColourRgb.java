...
public class IfcColourRgb extends IfcColourSpecification implements IfcColourOrFactor
{
	...
	private double red; //IfcNormalisedRatioMeasure
	...
	private double green; //IfcNormalisedRatioMeasure
	...
	private double blue; //IfcNormalisedRatioMeasure
	...
	public IfcColourRgb(double red, double green, double blue)
	{
		this.red = red;
		this.green = green;
		this.blue = blue;
