...
public class IfcTextureCoordinateGenerator extends IfcTextureCoordinate
{
	...
	private List<Double> parameter = new ArrayList<Double>();
	...
	public IfcTextureCoordinateGenerator(com.buildingsmart.tech.ifc.IfcPresentationAppearanceResource.IfcSurfaceTexture[] maps, String mode)
	{
		super(maps);
		this.mode = mode;
	}
