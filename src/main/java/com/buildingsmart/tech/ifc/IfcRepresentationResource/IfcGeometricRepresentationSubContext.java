...
public class IfcGeometricRepresentationSubContext extends IfcGeometricRepresentationContext
{
	...
	private com.buildingsmart.tech.ifc.IfcRepresentationResource.IfcGeometricRepresentationContext parentContext;

	@JacksonXmlProperty(isAttribute=true, localName = "TargetScale")
	...
	private com.buildingsmart.tech.ifc.IfcMeasureResource.IfcPositiveRatioMeasure targetScale;
	...
	private com.buildingsmart.tech.ifc.IfcRepresentationResource.IfcGeometricProjectionEnum targetView;
	...
	public IfcGeometricRepresentationSubContext(int coordinateSpaceDimension, com.buildingsmart.tech.ifc.IfcGeometryResource.IfcAxis2Placement worldCoordinateSystem, com.buildingsmart.tech.ifc.IfcRepresentationResource.IfcGeometricRepresentationContext parentContext, com.buildingsmart.tech.ifc.IfcRepresentationResource.IfcGeometricProjectionEnum targetView)
	{
	...
	public com.buildingsmart.tech.ifc.IfcRepresentationResource.IfcGeometricRepresentationContext getParentContext() {
		return this.parentContext;
	}

	public void setParentContext(com.buildingsmart.tech.ifc.IfcRepresentationResource.IfcGeometricRepresentationContext parentContext) {
		this.parentContext = parentContext;
	}

	public com.buildingsmart.tech.ifc.IfcMeasureResource.IfcPositiveRatioMeasure getTargetScale() {
		return this.targetScale;
	}

	public void setTargetScale(com.buildingsmart.tech.ifc.IfcMeasureResource.IfcPositiveRatioMeasure targetScale) {
		this.targetScale = targetScale;
	}

	public com.buildingsmart.tech.ifc.IfcRepresentationResource.IfcGeometricProjectionEnum getTargetView() {
		return this.targetView;
	}

	public void setTargetView(com.buildingsmart.tech.ifc.IfcRepresentationResource.IfcGeometricProjectionEnum targetView) {
		this.targetView = targetView;
	}
