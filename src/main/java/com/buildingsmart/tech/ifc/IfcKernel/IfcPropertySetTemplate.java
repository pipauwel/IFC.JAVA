...
public class IfcPropertySetTemplate extends IfcPropertyTemplateDefinition
{
	...
	private com.buildingsmart.tech.ifc.IfcKernel.IfcPropertySetTemplateTypeEnum templateType;

	@JacksonXmlProperty(isAttribute=true, localName = "ApplicableEntity")
	...
	private Set<com.buildingsmart.tech.ifc.IfcKernel.IfcRelDefinesByTemplate> defines = new HashSet<com.buildingsmart.tech.ifc.IfcKernel.IfcRelDefinesByTemplate>();
	...
	public IfcPropertySetTemplate(String globalId, com.buildingsmart.tech.ifc.IfcKernel.IfcPropertyTemplate[] hasPropertyTemplates)
	{
		super(globalId);
		this.hasPropertyTemplates = new HashSet<>(Arrays.asList(hasPropertyTemplates));
	}

	public com.buildingsmart.tech.ifc.IfcKernel.IfcPropertySetTemplateTypeEnum getTemplateType() {
		return this.templateType;
	}

	public void setTemplateType(com.buildingsmart.tech.ifc.IfcKernel.IfcPropertySetTemplateTypeEnum templateType) {
	...
	public Set<com.buildingsmart.tech.ifc.IfcKernel.IfcRelDefinesByTemplate> getDefines() {
		return this.defines;
	}
