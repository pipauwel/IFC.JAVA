...
public class IfcExternalSpatialElement extends IfcExternalSpatialStructureElement implements IfcSpaceBoundarySelect
{
	...
	private com.buildingsmart.tech.ifc.IfcProductExtension.IfcExternalSpatialElementTypeEnum predefinedType;
	...
	public com.buildingsmart.tech.ifc.IfcProductExtension.IfcExternalSpatialElementTypeEnum getPredefinedType() {
		return this.predefinedType;
	}

	public void setPredefinedType(com.buildingsmart.tech.ifc.IfcProductExtension.IfcExternalSpatialElementTypeEnum predefinedType) {
