...
public class IfcRelSequence extends com.buildingsmart.tech.ifc.IfcKernel.IfcRelConnects
{
	...
	private com.buildingsmart.tech.ifc.IfcKernel.IfcProcess relatingProcess;
	...
	private com.buildingsmart.tech.ifc.IfcKernel.IfcProcess relatedProcess;
	...
	private com.buildingsmart.tech.ifc.IfcDateTimeResource.IfcLagTime timeLag;
	...
	private com.buildingsmart.tech.ifc.IfcProcessExtension.IfcSequenceEnum sequenceType;
	...
	public IfcRelSequence(String globalId, com.buildingsmart.tech.ifc.IfcKernel.IfcProcess relatingProcess, com.buildingsmart.tech.ifc.IfcKernel.IfcProcess relatedProcess)
	{
		super(globalId);
	...
	public com.buildingsmart.tech.ifc.IfcKernel.IfcProcess getRelatingProcess() {
		return this.relatingProcess;
	}

	public void setRelatingProcess(com.buildingsmart.tech.ifc.IfcKernel.IfcProcess relatingProcess) {
		this.relatingProcess = relatingProcess;
	}

	public com.buildingsmart.tech.ifc.IfcKernel.IfcProcess getRelatedProcess() {
		return this.relatedProcess;
	}

	public void setRelatedProcess(com.buildingsmart.tech.ifc.IfcKernel.IfcProcess relatedProcess) {
		this.relatedProcess = relatedProcess;
	}

	public com.buildingsmart.tech.ifc.IfcDateTimeResource.IfcLagTime getTimeLag() {
		return this.timeLag;
	}

	public void setTimeLag(com.buildingsmart.tech.ifc.IfcDateTimeResource.IfcLagTime timeLag) {
		this.timeLag = timeLag;
	}

	public com.buildingsmart.tech.ifc.IfcProcessExtension.IfcSequenceEnum getSequenceType() {
		return this.sequenceType;
	}

	public void setSequenceType(com.buildingsmart.tech.ifc.IfcProcessExtension.IfcSequenceEnum sequenceType) {
