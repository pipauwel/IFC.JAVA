...
public class IfcStructuralAnalysisModel extends com.buildingsmart.tech.ifc.IfcProductExtension.IfcSystem
{
	...
	private com.buildingsmart.tech.ifc.IfcStructuralAnalysisDomain.IfcAnalysisModelTypeEnum predefinedType;
	...
	private com.buildingsmart.tech.ifc.IfcGeometryResource.IfcAxis2Placement3D orientationOf2DPlane;

	@Description("References to all load groups to be analyzed.")
	@MinLength(1)
	@Guid("db84f7ed-e47b-43d7-a93c-f42d6aa1eda4")
	private Set<com.buildingsmart.tech.ifc.IfcStructuralAnalysisDomain.IfcStructuralLoadGroup> loadedBy = new HashSet<com.buildingsmart.tech.ifc.IfcStructuralAnalysisDomain.IfcStructuralLoadGroup>();
	...
	private Set<com.buildingsmart.tech.ifc.IfcStructuralAnalysisDomain.IfcStructuralResultGroup> hasResults = new HashSet<com.buildingsmart.tech.ifc.IfcStructuralAnalysisDomain.IfcStructuralResultGroup>();
	...
	private com.buildingsmart.tech.ifc.IfcGeometricConstraintResource.IfcObjectPlacement sharedPlacement;
	...
	public IfcStructuralAnalysisModel(String globalId, com.buildingsmart.tech.ifc.IfcStructuralAnalysisDomain.IfcAnalysisModelTypeEnum predefinedType)
	{
		super(globalId);
		this.predefinedType = predefinedType;
	}

	public com.buildingsmart.tech.ifc.IfcStructuralAnalysisDomain.IfcAnalysisModelTypeEnum getPredefinedType() {
		return this.predefinedType;
	}

	public void setPredefinedType(com.buildingsmart.tech.ifc.IfcStructuralAnalysisDomain.IfcAnalysisModelTypeEnum predefinedType) {
		this.predefinedType = predefinedType;
	}

	public com.buildingsmart.tech.ifc.IfcGeometryResource.IfcAxis2Placement3D getOrientationOf2DPlane() {
		return this.orientationOf2DPlane;
	}

	public void setOrientationOf2DPlane(com.buildingsmart.tech.ifc.IfcGeometryResource.IfcAxis2Placement3D orientationOf2DPlane) {
		this.orientationOf2DPlane = orientationOf2DPlane;
	}

	public Set<com.buildingsmart.tech.ifc.IfcStructuralAnalysisDomain.IfcStructuralLoadGroup> getLoadedBy() {
		return this.loadedBy;
	}

	public Set<com.buildingsmart.tech.ifc.IfcStructuralAnalysisDomain.IfcStructuralResultGroup> getHasResults() {
		return this.hasResults;
	}

	public com.buildingsmart.tech.ifc.IfcGeometricConstraintResource.IfcObjectPlacement getSharedPlacement() {
		return this.sharedPlacement;
	}

	public void setSharedPlacement(com.buildingsmart.tech.ifc.IfcGeometricConstraintResource.IfcObjectPlacement sharedPlacement) {
