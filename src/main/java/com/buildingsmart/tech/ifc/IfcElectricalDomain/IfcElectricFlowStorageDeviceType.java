...
public class IfcElectricFlowStorageDeviceType extends com.buildingsmart.tech.ifc.IfcSharedBldgServiceElements.IfcFlowStorageDeviceType
{
	...
	public IfcElectricFlowStorageDeviceType(String globalId, com.buildingsmart.tech.ifc.IfcElectricalDomain.IfcElectricFlowStorageDeviceTypeEnum predefinedType)
	{
		super(globalId);
