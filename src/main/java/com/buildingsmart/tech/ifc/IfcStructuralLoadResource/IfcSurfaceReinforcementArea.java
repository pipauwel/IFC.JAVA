...
{
	@JacksonXmlProperty(isAttribute=true, localName = "SurfaceReinforcement1")
	...
	private List<Double> surfaceReinforcement1 = new ArrayList<Double>();

	@JacksonXmlProperty(isAttribute=true, localName = "SurfaceReinforcement2")
	...
	private List<Double> surfaceReinforcement2 = new ArrayList<Double>();
