...
public class IfcMaterialProfileSet extends IfcMaterialDefinition
{
	...
	private List<com.buildingsmart.tech.ifc.IfcMaterialResource.IfcMaterialProfile> materialProfiles = new ArrayList<com.buildingsmart.tech.ifc.IfcMaterialResource.IfcMaterialProfile>();
	...
	private com.buildingsmart.tech.ifc.IfcProfileResource.IfcCompositeProfileDef compositeProfile;
	...
	public IfcMaterialProfileSet(com.buildingsmart.tech.ifc.IfcMaterialResource.IfcMaterialProfile[] materialProfiles)
	{
	...
	public List<com.buildingsmart.tech.ifc.IfcMaterialResource.IfcMaterialProfile> getMaterialProfiles() {
		return this.materialProfiles;
	}

	public com.buildingsmart.tech.ifc.IfcProfileResource.IfcCompositeProfileDef getCompositeProfile() {
		return this.compositeProfile;
	}

	public void setCompositeProfile(com.buildingsmart.tech.ifc.IfcProfileResource.IfcCompositeProfileDef compositeProfile) {
