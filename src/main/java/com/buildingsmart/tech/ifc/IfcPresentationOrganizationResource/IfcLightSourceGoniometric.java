...
import com.buildingsmart.tech.ifc.IfcPresentationOrganizationResource.IfcLightEmissionSourceEnum;
import com.buildingsmart.tech.ifc.IfcPresentationOrganizationResource.IfcLightDistributionDataSourceSelect;
...
public class IfcLightSourceGoniometric extends IfcLightSource
{
	...
	public IfcLightSourceGoniometric(IfcColourRgb lightColour, IfcAxis2Placement3D position, double colourTemperature, double luminousFlux, IfcLightEmissionSourceEnum lightEmissionSource, IfcLightDistributionDataSourceSelect lightDistributionDataSource)
	{
		super(lightColour);
