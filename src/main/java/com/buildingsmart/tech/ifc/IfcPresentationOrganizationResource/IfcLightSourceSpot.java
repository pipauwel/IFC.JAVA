...
public class IfcLightSourceSpot extends IfcLightSourcePositional
{
	...
	@JacksonXmlProperty(isAttribute=true, localName = "SpreadAngle")
	...
	private com.buildingsmart.tech.ifc.IfcMeasureResource.IfcPositivePlaneAngleMeasure spreadAngle;

	@JacksonXmlProperty(isAttribute=true, localName = "BeamWidthAngle")
	...
	private com.buildingsmart.tech.ifc.IfcMeasureResource.IfcPositivePlaneAngleMeasure beamWidthAngle;
	...
	public IfcLightSourceSpot(com.buildingsmart.tech.ifc.IfcPresentationAppearanceResource.IfcColourRgb lightColour, com.buildingsmart.tech.ifc.IfcGeometryResource.IfcCartesianPoint position, com.buildingsmart.tech.ifc.IfcMeasureResource.IfcPositiveLengthMeasure radius, double constantAttenuation, double distanceAttenuation, double quadricAttenuation, com.buildingsmart.tech.ifc.IfcGeometryResource.IfcDirection orientation, com.buildingsmart.tech.ifc.IfcMeasureResource.IfcPositivePlaneAngleMeasure spreadAngle, com.buildingsmart.tech.ifc.IfcMeasureResource.IfcPositivePlaneAngleMeasure beamWidthAngle)
	{
	...
	public com.buildingsmart.tech.ifc.IfcMeasureResource.IfcPositivePlaneAngleMeasure getSpreadAngle() {
		return this.spreadAngle;
	}

	public void setSpreadAngle(com.buildingsmart.tech.ifc.IfcMeasureResource.IfcPositivePlaneAngleMeasure spreadAngle) {
		this.spreadAngle = spreadAngle;
	}

	public com.buildingsmart.tech.ifc.IfcMeasureResource.IfcPositivePlaneAngleMeasure getBeamWidthAngle() {
		return this.beamWidthAngle;
	}

	public void setBeamWidthAngle(com.buildingsmart.tech.ifc.IfcMeasureResource.IfcPositivePlaneAngleMeasure beamWidthAngle) {
		this.beamWidthAngle = beamWidthAngle;
	}
